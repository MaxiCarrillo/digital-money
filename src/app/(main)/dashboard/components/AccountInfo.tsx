    ...
    return (
        <article className='bg-background p-8 rounded-lg shadow-background/70 shadow-md text-foreground'>
            <div className='flex justify-end gap-4'>
                <Link href='/dashboard/tarjetas' className="border-b text-xs sm:text-base">Ver tarjetas</Link>
                <Link href='/dashboard/perfil' className="border-b text-xs sm:text-base">Ver CVU</Link>
            </div>
