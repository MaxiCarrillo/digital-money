...
const FilterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <circle cx="5.09896" cy="9.63314" r="2.33333" fill="#C1FD35" stroke="#201F22" />
        <circle cx="11.901" cy="2.83366" r="2.33333" transform="rotate(-180 11.901 2.83366)" fill="#C1FD35" stroke="#201F22" />
    </svg>
);
